...
const CubicRob = () => {
    const group = useRef()
    const { nodes, materials, animations } = useGLTF('../../../public/twelve_the_robot_low_poly.glb')
...
useGLTF.preload('../../../public/twelve_the_robot_low_poly.glb')

export default CubicRob